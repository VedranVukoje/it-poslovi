 ...
 * @author vedran
 */
class JobAdTypeOfJobsWasManaged implements EventSubscriber
{
    private $es;
    ...
    {
        return \JobAd\Domain\Model\JobAdvertisement\Events\JobAdTypeOfJobsWasManaged::class === get_class($event);
    }
